...
from event.consumers import ConsumerMethods
...
class Consumer:
    ...
    process_incoming_message_methods = {
        "contractor/eventAck": ConsumerMethods.process_incoming_ack,
        "contractor/removeOrganization": ConsumerMethods.process_incoming_remove_organization,
    }
